...
* | Info        :
*
* Vendored verbatim from Waveshare's official 5in83_e-Paper_G/ESP32 demo.
* This file is pin-agnostic (uses the macros from DEV_Config.h), so it is
* UNMODIFIED. SPI here is bit-banged, so any GPIOs may be used.
******************************************************************************/
