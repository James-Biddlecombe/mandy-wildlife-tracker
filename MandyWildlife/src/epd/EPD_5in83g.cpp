...
* -----------------------------------------------------------------------------
*
* Vendored verbatim from Waveshare's official demo:
*   waveshareteam/e-Paper  ->
*   E-paper_Separate_Program/5in83_e-Paper_G/ESP32/EPD_5in83g.cpp
*
* This file is UNMODIFIED. Only DEV_Config.h has been changed
* (GPIO pins repointed to this project's authoritative wiring).
******************************************************************************/
